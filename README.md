...
¿Conoce la población estudiantil del Instituto Tecnológico de Costa Rica acerca de la computación en la nube?
...
* Definir los conceptos básicos de la computación en la nube. 

* Analizar el conocimiento de la comunidad estudiantil del Instituto Tecnológico de Costa Rica acerca de la computación en la nube.
...
* Bareras de entrada económicas, poniéndolas a disposición de las pequeñas empresas.  
...
[Video Demostrativo de la Aplicación Paas](https://github.com/NachoGranados/ITCR.DATOS1.Investigacion/blob/master/Video/PaaS.mp4?raw=true)
...
Después de un profundo análisis de la encuesta, se logra visualizar cómo las personas poseen un escaso conocimiento acerca de la computación en la nube. A pesar de que, diariamente, utilizan diversas aplicaciones y páginas web que consumen dichos servicios, sin percatarse de los recursos que estas utilizan. Por lo que, se recomienda que las compañías, encargadas de brindar estos servicios, se comprometan a instruir a la población, con múltiples técnicas, que expongan, de manera simple y concisa, los conceptos básicos de estos medios informáticos. Esto con el fin de ampliar el conocimiento que presentan las personas acerca de estas tecnologías que forman parte de la vida cotidiana y futuro de las empresas.
...
[5] P. Mell, T. Grance, “The NIST Definition of Cloud Computing”, National Institute of Standards and Technology, NIST Special Publication 800-145, 2011. Recuperado de: [Visitar](http://faculty.winthrop.edu/domanm/csci411/Handouts/NIST.pdf)
...
1. ¿Ha escuchado acerca de computación en la nube?
* No
* Sí
* He escuchado pero no sé


2. Conoce los servicios de computación en la nube?
* Sí
* No
...
4. ¿Sabe usted que estas aplicaciones y muchas otras utilizan servicios de computación en la nube?
* No
* Sí
